...
#include "Stormlight/Renderer/VertexArray.h"
#include "Stormlight/Renderer/Shader.h"
#include "Stormlight/Renderer/UniformBuffer.h"
#include "Stormlight/Renderer/RenderCommand.h"
...
namespace Stormlight {
	...
	{
		//casting this to subvert a warning
	...
	void Renderer2D::DrawQuad(const glm::mat4& transform, const Ref<SubTexture2D>& texture, float tilingFactor, const glm::vec4& tintColor, int entityID)
	{
		constexpr size_t quadVertexCount = 4;
